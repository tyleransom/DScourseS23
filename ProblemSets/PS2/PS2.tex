...
As with the previous proble set, you will submit this problem set by pushing the document to \emph{your} (private) fork of the class repository. You will put this and all other problem sets in the path \texttt{/DScourseS23/ProblemSets/PS2/} and name the file \texttt{PS2\_LastName.pdf}.
\begin{questions}
...
\begin{enumerate}
	...
	\item Type \texttt{git clone https://github.com/[your-github-username]/DScourseS23.git}
