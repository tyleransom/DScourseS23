...
\pagestyle{head}
\firstpageheader{\textbf{\class\ - \term}}{\textbf{\examnum}}{\textbf{Due: Feb. 14\\ beginning of class}}
\runningheader{\textbf{\class\ - \term}}{\textbf{\examnum}}{\textbf{Due: Feb. 14\\ beginning of class}}
\runningheadrule

\newcommand{\class}{Econ 5253}
\newcommand{\term}{Spring 2023}
\newcommand{\examdate}{Due: February 14, 2023}
...
\end{itemize}
\begin{questions}
\question Log in to OSCER, change to the directory where you cloned your forked GitHub repository (probably \texttt{\~/DScourseS23}), and make sure the OSCER version of your repository is synchronized with what is listed on GitHub by issuing a pull. That is, type \texttt{git pull origin master} from your OSCER \texttt{DScourseS23} folder. 

\question Create the PS3 subdirectory by issuing \texttt{cd \~/DScourseS23/ProblemSets} followed by \texttt{mkdir PS3} on OSCER. Change into this directory by typing \texttt{cd PS3}.
...
\question You should turn in the following files: .tex, .pdf, .sql, and .sh. Make sure that these files each have the correct naming convention (see top of this problem set for directions) and are located in the correct directory (i.e. \texttt{~/DScourseS23/ProblemSets/PS3}).
