...
| Mar 2   | Th   | Using JuMP to optimize cool stuff ([Jupyter Notebook](https://github.com/tyleransom/DScourseS22/blob/master/LectureNotes/14-JuMP/JuMPintro.ipynb); [slightly modified Julia Code](https://github.com/tyleransom/DScourseS23/blob/master/LectureNotes/14-JuMP/JuMPintro.jl)) (in previous years: Linear Algebra Introduction / Review ([Handout](https://minireference.com/static/tutorials/linear_algebra_in_4_pages.pdf))) | |
